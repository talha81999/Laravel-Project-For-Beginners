	...
	<div class="row">
        ...
        <div class="container-fluid p-3">
            <div class="card">
                ...
                <form method="post" action="{{url('/admin/addtask')}}" enctype="multipart/form-data">
                @csrf
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="date"  class="form-control" name="task_due" placeholder="Enter task due">
                                    <span class="text-danger">
                                        @error('task_due')
                                        {{$message}}
                                        @enderror
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text"  class="form-control" name="project_task_team_lead" placeholder="Enter team lead" id="project_task_team_lead">
                                    <input type="hidden"  class="form-control" name="project_task_team_lead_id" id="project_task_team_lead_id">
                                    <span class="text-danger">
